...
import {
  ...
  ModalContent,
  ModalTrigger,
} from '@/components/animates-ui/animate-modal';
...
export function AnimateModalProjectDetail({
  ...
  const [currentState, setCurrentState] = useState<IProject>(currentPro);
  ...
  return (
    <div className="flex items-center justify-center py-40">
      <Modal>
        <ModalTrigger className="group/modal-btn flex justify-center">
          {children}
        </ModalTrigger>
        <ModalBody>
          <ModalContent>
            <div className="overflow-t-auto h-full overflow-x-hidden">
              <AppWindow
