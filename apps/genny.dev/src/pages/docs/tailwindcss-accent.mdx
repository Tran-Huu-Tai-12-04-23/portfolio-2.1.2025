...
caption: Plugin
githubUrl: https://github.com/Gennydev/tailwindcss-accent
...
See the [configuration](https://github.com/Gennydev/genny.dev/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/genny.dev/tailwind.config.js#L54-L57) file and [implementation](https://github.com/Gennydev/genny.dev/blob/a6078ba395ea65cc9c1a7ea524adb29b9580406d/apps/genny.dev/src/providers/ColorAccentProvider.tsx#L18-L20) code for details.
