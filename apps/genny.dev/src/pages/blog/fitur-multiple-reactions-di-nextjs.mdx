...
- `sessionId`
  ...
  Atau kalau mau inspect langsung juga gasss [kesini](https://github.com/Huu Taidev/genny.dev/blob/425e3c09c906c005a7e1d9efbf21b87906ffd443/apps/genny.dev/src/helpers/server.ts).
...
Bingung ya? hehe maaf, coba cek [full kodenya](https://github.com/Huu Taidev/genny.dev/blob/425e3c09c906c005a7e1d9efbf21b87906ffd443/apps/genny.dev/src/components/EmojiReaction.tsx).
...
Tapi kayanya bakal update di [Twitter](https://twitter.com/Huu Taidev), ngga bakal dibikinin postingan khusus.
